const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-Cyc3Yyj6.js","./ui-ChzvFN3S.js","./jspdf.es.min-C-cb9Fb9.js","./app-DWO-lrzc.js","./app-ZlEoZMi-.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-DWO-lrzc.js";import{a0 as i}from"./ui-ChzvFN3S.js";import{B as x}from"./button-BZdd3rnH.js";import{T as f,c as b,a as h}from"./tooltip-CZiVFnnC.js";import{b as v,c as r,e as p}from"./helpers-CP6nNuIR.js";import{u as _}from"./useTranslation-DIFzoUNv.js";import{D as y}from"./download-CxWgwRCf.js";import"./index-BGIHhPU-.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-CmeZxMYV.js";import"./index-BohFs3gf.js";import"./createLucideIcon-DoMMFY-K.js";function F({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var n;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-Cyc3Yyj6.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{F as default};
