import{a as v}from"./html2pdf-CwKhjylI.js";import{c as f,b as n}from"./helpers-DrZzmirM.js";import"./ui-CUd_MbMF.js";import"./app-Cvy9WmVZ.js";const h=async(s,a)=>{var r;const c=`
        <div class="receipt">
            <div class="header">
    ...
    `,t=document.createElement("div");t.innerHTML=c,document.body.appendChild(t);const m={margin:.1,filename:`receipt-${s.pos_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"mm",format:[80,297],orientation:"portrait"}};try{await v().set(m).from(t).save()}catch(i){console.error("PDF generation failed:",i)}finally{document.body.removeChild(t)}};export{h as downloadReceiptPDF};
