const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-DxmcooPZ.js","./ui-CUd_MbMF.js","./jspdf.es.min-CSyEpt6Z.js","./app-DFithf4b.js","./app-CcuUqH00.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-DFithf4b.js";import{a0 as i}from"./ui-CUd_MbMF.js";import{B as x}from"./button-C5lU6IWQ.js";import{T as f,c as b,a as h}from"./tooltip-B1QroYc9.js";import{b as v,c as r,e as p}from"./helpers-zhQbzJ4g.js";import{u as _}from"./useTranslation-Cr16uoUo.js";import{D as y}from"./download-DerphYxa.js";import"./index-DhI_wT7_.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-CmeZxMYV.js";import"./index-C95eaBd0.js";import"./createLucideIcon-BzOPnGyp.js";function F({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var n;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-DxmcooPZ.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{F as default};
