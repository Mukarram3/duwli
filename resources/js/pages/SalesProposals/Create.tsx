...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            ...
            pageDescription={t('Fill in the details below to create a new sales proposal.')}
                            ...
                            <Card className="border border-border shadow-md rounded-xl overflow-hidden bg-card">
                                ...
                                <CardContent className="p-6">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 mt-4 border border-dashed border-primary/30 dark:border-primary/50 rounded-xl text-sm font-medium text-primary bg-primary/10 hover:bg-primary/10 hover:border-primary/40 dark:bg-primary/10 dark:hover:bg-primary/10 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                                    >
