...
function AuthenticatedLayoutContent({
    ...
    return (
        ...
        <SidebarProvider defaultOpen={true}>
            ...
            >
                <header
                    className={`bg-background flex h-12 shrink-0 items-center gap-2 px-12 py-1 border-b mb-2 justify-between`}
                    >
                    {/* Sidebar + Breadcrumb */}
                ...
                <main className="p-12 md:pt-0 h-full">
                    {pageTitle && (
                        <div className="flex items-center justify-between mb-4 gap-3" dir={settings.layoutDirection}>
                            <div>
