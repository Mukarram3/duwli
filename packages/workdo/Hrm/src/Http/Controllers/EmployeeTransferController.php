...
class EmployeeTransferController extends Controller
{
    public function index()
    {
        if (Auth::user()->can('manage-employee-transfers')) {
            $baseQuery = EmployeeTransfer::query()
                ->where(function ($q) {
            ...
            $employeetransfers = (clone $baseQuery)
                ->with(['employee:id,name,avatar,email', 'from_branch:id,branch_name', 'from_department:id,department_name', 'from_designation:id,designation_name', 'to_branch:id,branch_name', 'to_department:id,department_name', 'to_designation:id,designation_name', 'approved_by:id,name,avatar'])
