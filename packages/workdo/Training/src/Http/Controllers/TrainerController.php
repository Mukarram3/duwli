...
class TrainerController extends Controller
{
    public function index()
    {
        if(Auth::user()->can('manage-trainers')){
            ...
            $branchCounts = Department::where('created_by', creatorId())
    ...
    public function store(StoreTrainerRequest $request)
    {
        if(Auth::user()->can('create-trainers')){
            ...
            return redirect()->route('training.trainers.index', [
                'branch_id' => $trainer->branch_id,
                'department_id' => $trainer->department_id
            ])->with('success', __('The trainer has been created successfully.'));
        }
        else{
