                                            ...
                                            <Card key={candidateonboarding.id} className="flex flex-col h-full hover:shadow-md transition-shadow duration-200">
                                                ...
                                                <div className="flex-1 p-3 space-y-3">
                                                    <div className="text-xs min-w-0">
                                                        <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Checklist')}</p>
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        ...
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Buddy')}</p>
                                                            <p className="font-medium">{candidateonboarding.buddy?.name || '-'}</p>
                                                        </div>
                                                    </div>
                                                    <div className="text-xs min-w-0">
                                                        <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Created')}</p>
