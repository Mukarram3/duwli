                                                ...
                                                <div className="flex items-center gap-3 p-3 border-b bg-gray-50/50">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        ...
                                                        {candidateassessment.candidate?.job_posting?.title && (
                                                            <p className="text-xs text-muted-foreground truncate">{candidateassessment.candidate.job_posting.title}</p>
                                                        )}
                                                    </div>
                                                </div>
                                                <div className="flex-1 p-3 space-y-3">
                                                    ...
                                                    <div className="text-xs min-w-0">
                                                        <div className="flex justify-between items-center mb-1">
                                                            <p className="text-muted-foreground text-xs capitalize tracking-wide">{t('Score')}</p>
