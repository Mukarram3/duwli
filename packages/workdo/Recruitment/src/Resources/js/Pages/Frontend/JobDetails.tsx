                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                            <div className="bg-gray-50 rounded-lg p-4">
                                                ...
                                                <p className="text-xs text-gray-500 capitalize tracking-wide mb-1"> {t('Salary Range')} </p>
                                            ...
                                            <div className="bg-gray-50 rounded-lg p-4">
                                                ...
                                                <p className="text-xs text-gray-500 capitalize tracking-wide mb-1"> {t('Job Type')} </p>
                                                <p className="font-bold text-gray-900">{job.jobType}</p>
                                            </div>
                                            <div className="bg-gray-50 rounded-lg p-4">
                                                <Users className="h-6 w-6 mb-2 text-purple-600" />
                                                <p className="text-xs text-gray-500 capitalize tracking-wide mb-1"> {t('Positions')} </p>
                                                <p className="font-bold text-gray-900">{job.positions} {t('Available')} </p>
                                            </div>
                                            <div className="bg-red-50 rounded-lg p-4">
                                                <Clock className="h-6 w-6 mb-2 text-red-600" />
                                                <p className="text-xs text-gray-500 capitalize tracking-wide mb-1"> {t('Deadline')} </p>
