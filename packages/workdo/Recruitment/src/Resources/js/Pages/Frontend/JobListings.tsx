                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                                    <div className="flex items-center bg-gray-50 rounded-lg p-3">
                                                        ...
                                                        <div>
                                                            <p className="text-xs text-gray-500 capitalize tracking-wide">{t('Salary')}</p>
                                                    ...
                                                    <div className="flex items-center bg-gray-50 rounded-lg p-3">
                                                        ...
                                                        <div>
                                                            <p className="text-xs text-gray-500 capitalize tracking-wide">{t('Type')}</p>
                                                    ...
                                                    <div className="flex items-center bg-gray-50 rounded-lg p-3">
                                                        ...
                                                        <div>
                                                            <p className="text-xs text-gray-500 capitalize tracking-wide">{t('Posted')}</p>
                                                    ...
                                                    {job.deadlineDate && (
                                                        <div className="flex items-center bg-red-50 rounded-lg p-3">
                                                            ...
                                                            <div>
                                                                <p className="text-xs text-gray-500 capitalize tracking-wide">{t('Deadline')}</p>
                                                ...
                                                {job.skills && job.skills.length > 0 && (
                                                    <div className="mb-4">
                                                        <p className="text-xs text-gray-500 capitalize tracking-wide mb-2">{t('Required Skills')}</p>
                                                        <div className="flex flex-wrap gap-2">
