                                            ...
                                            <Card key={interview.id} className="flex flex-col h-full hover:shadow-md transition-shadow duration-200">
                                                ...
                                                <div className="flex-1 p-3 space-y-3">
                                                    <div className="text-xs min-w-0">
                                                        <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Schedule Date & Time')}</p>
                                                        <p className="font-medium">{formatDate(interview.scheduled_date)} • {formatTime(interview.scheduled_time)}</p>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Round')}</p>
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Location')}</p>
                                                        ...
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Duration')}</p>
                                                            <p className="font-medium">{interview.duration ? `${interview.duration} min` : '-'}</p>
                                                        </div>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Feedback')}</p>
