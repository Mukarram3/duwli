                                                ...
                                                <div className="flex-1 p-3 space-y-3">
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Position')}</p>
                                                            <p className="font-medium">{offer.position || '-'}</p>
                                                        </div>
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Salary')}</p>
                                                            <p className="font-medium">{offer.salary ? formatCurrency(offer.salary) : '-'}</p>
                                                        </div>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Start Date')}</p>
                                                            <p className="font-medium">{offer.start_date ? formatDate(offer.start_date) : '-'}</p>
                                                        </div>
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Expiration')}</p>
                                                            <p className={`font-medium ${isExpired ? 'text-red-600' : ''}`}>{offer.expiration_date ? formatDate(offer.expiration_date) : '-'}</p>
                                                        </div>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Offer Date')}</p>
                                                            <p className="font-medium">{offer.offer_date ? formatDate(offer.offer_date) : '-'}</p>
                                                        </div>
                                                        <div className="text-xs min-w-0">
                                                            <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Status')}</p>
                                                    ...
                                                    <div className="text-xs min-w-0">
                                                        <p className="text-muted-foreground mb-1 text-xs capitalize tracking-wide">{t('Department')}</p>
