...
export default function General({ lead }: GeneralProps) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-border/80">
                <div className="space-y-1">
                    <div className="flex items-center gap-3">
                        ...
                        {lead.is_converted ? (
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-green-500/10 text-green-600 border border-green-500/20 capitalize">
                                {t('Converted to Deal')}
                            </span>
                        ) : (
                    ...
                    {lead.subject && (
                        <p className="text-sm text-muted-foreground font-medium">{lead.subject}</p>
                    )}
                </div>
            ...
            {/* 2. Theme-Based Stats Cards (Matching Manage Projects layout style) */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="relative overflow-hidden bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200 dark:from-blue-900/30 dark:to-blue-800/20 dark:border-blue-800/50 shadow-none hover:shadow-md transition-shadow duration-200 rounded-xl">
                    ...
                    <CardContent className="px-5 pb-5 pt-0">
                        <div className="text-2xl font-bold text-blue-700 dark:text-blue-300">{lead.emails?.length ?? 0}</div>
                    </CardContent>
                </Card>
                ...
                <Card className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-emerald-100 border-emerald-200 dark:from-emerald-900/30 dark:to-emerald-800/20 dark:border-emerald-800/50 shadow-none hover:shadow-md transition-shadow duration-200 rounded-xl">
                    ...
                    <CardContent className="px-5 pb-5 pt-0">
                        <div className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">{sourceItemsList.length}</div>
                    </CardContent>
                </Card>
                ...
                <Card className="relative overflow-hidden bg-gradient-to-r from-amber-50 to-amber-100 border-amber-200 dark:from-amber-900/30 dark:to-amber-800/20 dark:border-amber-800/50 shadow-none hover:shadow-md transition-shadow duration-200 rounded-xl">
                    ...
                    <CardContent className="px-5 pb-5 pt-0">
                        <div className="text-2xl font-bold text-amber-700 dark:text-amber-300">{productItemsList.length}</div>
                    </CardContent>
                </Card>
                ...
                <Card className="relative overflow-hidden bg-gradient-to-r from-violet-50 to-violet-100 border-violet-200 dark:from-violet-900/30 dark:to-violet-800/20 dark:border-violet-800/50 shadow-none hover:shadow-md transition-shadow duration-200 rounded-xl">
                    ...
                    <CardContent className="px-5 pb-5 pt-0">
                        <div className="text-2xl font-bold text-violet-700 dark:text-violet-300">{lead.tasks?.length ?? 0}</div>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    {/* Description Area */}
                    {lead.description && (
                        <div className="bg-card border border-gray-300 dark:border-gray-700 shadow-md rounded-xl p-5">
                        ...
                        <div className="space-y-5 flex-1">
                            ...
                            <div className="flex items-start gap-4 group">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <a href={`mailto:${lead.email}`} className="text-base font-bold text-blue-600 dark:text-blue-400 hover:underline truncate block mt-0.5">
                                        {lead.email || '-'}
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 group">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <a href={`tel:${lead.phone}`} className="text-base font-bold text-foreground hover:text-primary block mt-0.5">
                                        {lead.phone || '-'}
                                    </a>
                                </div>
                            </div>
                            {/* Follow Up Date */}
                            <div className="flex items-start gap-4 group">
                                <div className="mt-0.5 h-10 w-10 rounded-lg bg-orange-500/10 border border-orange-500/20 flex items-center justify-center flex-shrink-0 text-orange-600 dark:text-orange-400 group-hover:scale-105 transition-transform duration-200">
                            ...
                            <div className="flex items-start gap-4 group">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-xs font-bold text-muted-foreground/95 capitalize">{t('Lead Stage')}</p>
                                    <p className="text-base font-bold text-foreground mt-0.5">
                                        {lead.stage?.name || '-'}
                                    </p>
                                </div>
            ...
            {/* 4. Emails & Discussions Row (Full Row, Side-by-Side) */}
