                    ...
                    <tbody>
                        {data.vendors.map((vendor: any, idx: number) => (
                            <tr key={idx} className="border-b border-gray-200">
                                ...
                                <td className="py-2 px-2 text-sm text-end">{formatCurrency(vendor.current)}</td>
                                <td className="py-2 px-2 text-sm text-end">{formatCurrency(vendor['1_30_days'])}</td>
                                <td className="py-2 px-2 text-sm text-end">{formatCurrency(vendor['31_60_days'])}</td>
                                <td className="py-2 px-2 text-sm text-end">{formatCurrency(vendor['61_90_days'])}</td>
                                <td className="py-2 px-2 text-sm text-end">{formatCurrency(vendor.over_90_days)}</td>
                                <td className="py-2 px-2 text-sm text-end font-semibold">{formatCurrency(vendor.total)}</td>
                            </tr>
                        ))}
